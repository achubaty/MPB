...
MPBfit <- simInit(times = timesFit, params = paramsFit, modules = modules,
                  #objects = objects,
                  loadOrder = unlist(modules))

data.table::setDTthreads(1L)

objectiveFunction <- function(MPBfit, paramsFit) {
  data.table::setDTthreads(1L)
  
  sim2 <- SpaDES.core::Copy(MPBfit)
  
  SpaDES.core::params(sim2)[["mpbRedTopSpread"]][["advectionDir"]] <- paramsFit[1]
  SpaDES.core::params(sim2)[["mpbRedTopSpread"]][["advectionMag"]] <- paramsFit[2]
  SpaDES.core::params(sim2)[["mpbRedTopSpread"]][["bgSettlingProp"]] <- paramsFit[3]
  SpaDES.core::params(sim2)[["mpbRedTopSpread"]][["meanDist"]] <- paramsFit[4]
...
outPOM <- DEoptim::DEoptim(fn = objectiveFunction,
                           ...
                           control = DEoptim::DEoptim.control(
                             ...
                             parallelType = 1,
                             parVar = list("objectiveFunction", "MPBfit", "paramsFit", "timesFit"),
                             VTR = 0
                           ),
