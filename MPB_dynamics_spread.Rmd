...
objectiveFunction <- function(params) {
  ...
  Sys.sleep(runif(1, 5, 1800)) ## random delay to mitigate database locked errors
  ...
  SpaDES.core::params(sim2)[["mpbRedTopSpread"]][["advectionDir"]] <- params[1]
  SpaDES.core::params(sim2)[["mpbRedTopSpread"]][["advectionMag"]] <- params[2]
  SpaDES.core::params(sim2)[["mpbRedTopSpread"]][["bgSettlingProp"]] <- params[3]
  SpaDES.core::params(sim2)[["mpbRedTopSpread"]][["meanDist"]] <- params[4]
  
  simOut <- SpaDES.core::spades(sim2, .plotInitialTime = NA)
...
#cl <- parallel::makeCluster(N / 2, type = "SOCK") ## forking doesn't work with data.table
