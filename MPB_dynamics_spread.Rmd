...
MPBfit <- SpaDES.core::simInit(times = timesFit, params = paramsFit, modules = modules,
                               #objects = objects,
...
objectiveFunction <- function(params) {
  ...
  sim <- SpaDES.core::simInit(times = timesFit, params = paramsFit, modules = modules,
                              #objects = objects,
                              loadOrder = unlist(modules))
...
outPOM <- DEoptim::DEoptim(fn = objectiveFunction,
                           control = DEoptim::DEoptim.control(
                             ...
                             parallelType = 1,
                             parVar = list("objectiveFunction", "modules", "paramsFit", "timesFit"),
                             VTR = 0
                           ),
