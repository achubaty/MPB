...
Install the most recent version of the `SpaDES` package from the development branch (packages version `1.3.1.9032` or higher is required.)
...
if (!require(SpaDES) | packageVersion("SpaDES", "~/R-dev") < "1.3.1.9032") {
