...
if (!require(amc) || packageVersion("amc") < "0.1.3.9002") {
  devtools::install_github("achubaty/amc", dependencies = TRUE)
}
if (!require(SpaDES) || packageVersion("SpaDES") < "2.0.0") {
  install.package("SpaDES")
}
```
...
```{r define-study-area}
## Canadian adminstrative boundaries
load("~/Documents/Data/shared/CAN_adm/CAN_adm1.Rdata") # CAN_adm1
load("~/Documents/Data/shared/CAN_adm/CAN_adm3.Rdata") # CAN_adm3
...
f <- normalizePath("~/GitHub/MPB/SpaDES/studyArea/studyArea.kml")
...
params <- list(
  ...
  mpbRedTopGrowth = list(dataset = "Boone_2011")
)
