...
test_dir("/home/achubaty/Documents/GitHub/MPB/SpaDES/modules/canDEM/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("/home/achubaty/Documents/GitHub/MPB/SpaDES/modules/canDEM/tests/testthat/test-template.R")
