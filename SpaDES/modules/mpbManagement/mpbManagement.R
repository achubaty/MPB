defineModule(sim, list(
  ...
  version = numeric_version("1.3.1.9033"),
  spatialExtent = raster::extent(rep(NA_real_, 4)),
  timeframe = as.POSIXlt(c(NA, NA)),
  timeunit = "year",
  citation = list("citation.bib"),
  documentation = list("README.txt", "mpbManagement.Rmd"),
  reqdPkgs = list(),
  parameters = rbind(
...
doEvent.mpbManagement = function(sim, eventTime, eventType, debug = FALSE) {
  switch(eventType,
    "init" = {
...
mpbManagementInit <- function(sim) {
  # # ! ----- EDIT BELOW ----- ! #
...
mpbManagementSave <- function(sim) {
  # ! ----- EDIT BELOW ----- ! #
  # do stuff for this event
  sim <- saveFiles(sim)
...
mpbManagementPlot <- function(sim) {
  # ! ----- EDIT BELOW ----- ! #
  # do stuff for this event
  #Plot("object")
...
mpbManagementManage <- function(sim) {
  # ! ----- EDIT BELOW ----- ! #
