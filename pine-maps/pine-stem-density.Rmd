...
Beaudoin et al. (2014) provide data on pine % and stand volume on 250m x 250m pixels.
From this we can compute pine volumes, m3/ha.
...
(MPB don’t remove xylem volume; they kill stems.) Stem density, however, is a function of age, and changed dynamically as a product of self-thinning over time.
