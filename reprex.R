suppressPackageStartupMessages({
  ...
  library(rgdal)
  library(raster)
  devtools::install_github("PredictiveEcology/SpaDES.tools@development") # need latest version for randomPolygon
...
crsString <- "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=0 +lon_0=-95 +x_0=0 +y_0=0 +datum=NAD83 +units=m +no_defs +ellps=GRS80 +towgs84=0,0,0"
...
Plot(pine100, title = c("Example pine map\nwith MPB spreading through landscape"), legend = FALSE,
     visualSqueeze = 0.6)
